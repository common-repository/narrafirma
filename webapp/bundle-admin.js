...
define('js/projectAdmin',["require", "exports", "./panelBuilder/toaster", "./pointrel20150417/PointrelClient", "mithril", "lodash"], function (require, exports, toaster, PointrelClient, m, _) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    "use strict";
    ...
    var AdminPageDisplayer = {
        ...
        view: function (controller, args) {
            ...
            var hrStyleText = "display: block; clear: both; height: 2px; border-top: 2px solid #c5d2eb; background-color: #c5d2eb; margin-top: 1em; margin-right: 1em; border-radius: 5px;";
            ...
            var pWithStyle = 'p[style="margin-right: 0.5em"]';
    ...
    function accessClicked(grantOrRevoke) {
    ...
    function updateUserInformation(userIdentifier, userInformation) {
        if (userInformation === void 0) { userInformation = undefined; }
        if (!userInformation) {
            userInformation = {
